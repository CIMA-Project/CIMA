...
SMR_output_dir = '/CIMA/Result/xQTL_GWAS_SMR/BBJ/'
...
for trait in trait_all:
    ...
    if celltype in caQTL_CT :
        gi = f'{smr} --bfile {bim} --gwas-summary {GWAS_dir}hum0197.v3.BBJ.{trait}.v1.ma --beqtl-summary {caQTL}  --thread-num 1  --out {SMR_output_dir}{trait}/caQTLsmr_{celltype}'
        os.system(gi)
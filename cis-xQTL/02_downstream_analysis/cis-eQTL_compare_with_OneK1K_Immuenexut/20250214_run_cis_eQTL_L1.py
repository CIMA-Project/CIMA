...
## Use tensorqtl
nominal_out_dir = f'/CIMA/Result/eQTL_tensorqtl_L1/{cell}/'
...
expression_bed = f'/CIMA/Data/eQTL_L1/bed_file/{cell}.bed'
covariates_file = f'/CIMA/Data/eQTL_L1/peer/peer_rez/factor/{cell}.csv'

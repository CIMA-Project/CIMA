...
fwrite(f_df, sprintf('/CIMA/Data/eQTL_L1/peer/peer_rez/factor/%s.csv',cell))
...
fwrite(w_df, sprintf('/CIMA/Data/eQTL_L1/peer/peer_rez/weights/%s.csv',cell))
...
p_df <- p_df[,c(2,1)]
fwrite(p_df, sprintf('/CIMA/Data/eQTL_L1/peer/peer_rez/precision/%s.csv',cell))
...
fwrite(r_df, sprintf('/CIMA/Data/eQTL_L1/peer/peer_rez/residuals/%s.csv',cell))

...
## Use tensorqtl
nominal_out_dir = f'/CIMA/Result/dynamic/pseudobulk/{cell}/'
...
expression_bed = f'/CIMA/Data/dynamic/pseudobulk/bed_file/{cell}.bed'
covariates_file = f'/CIMA/Data/dynamic/pseudobulk/peer/peer_rez/factor/{cell}.csv'

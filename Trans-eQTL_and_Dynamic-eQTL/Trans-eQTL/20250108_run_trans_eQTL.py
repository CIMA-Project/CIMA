...
expression_bed = f'/CIMA/Data/eQTL/bed_file/{cell}.bed'
covariates_file = f'/CIMA/Data/eQTL/peer/peer_rez/factor/{cell}.csv'
...
trans_df.to_parquet(f'/CIMA/Result/eQTL_trans/{cell}.parquet')
